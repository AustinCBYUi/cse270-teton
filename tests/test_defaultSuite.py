...
class TestDefaultSuite():
  ...
  def test_smoke(self):
    ...
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".main-event > h1")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.LINK_TEXT, "Join Us")
    assert len(elements) > 0
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("There")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Tester")
